// Mobile menu toggle
        ...
        document.getElementById('contactForm').addEventListener('submit', function(e) {
            ...
            const whatsappMessage = `Hello! I need construction services.
...
Project Details: ${message}`;
        ...
        window.addEventListener('scroll', () => {
            ...
            if (window.scrollY > 100) {
                header.style.background = 'linear-gradient(135deg, #1a1a1a, #000)';
            } else {
                header.style.background = 'linear-gradient(135deg, #000, #1a1a1a)';
            }
        });
        ...
        // Observe service and equipment cards
